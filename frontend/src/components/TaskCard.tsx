...
import { CheckCircle, XCircle, Clock, Loader2, ChevronRight, Square, Trash2 } from 'lucide-react'
import { Progress } from '@/components/ui/progress'
import { useTaskProgress } from '@/hooks/useTaskProgress'
import { cancelTask, deleteTask, type Task, type TaskStatus } from '@/lib/api'
